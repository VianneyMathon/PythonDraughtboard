...
if __name__ == '__main__':
    ...
    assert test.positions_diagonales_haut() == [Position(2, 2), Position(2, 4)]
    assert test.quatre_positions_diagonales() == [Position(2, 2), Position(2, 4), Position(4, 2), Position(4, 4)]
    assert test.quatre_positions_sauts() == [Position(1, 1), Position(1, 5), Position(5, 1), Position(5, 5)]
